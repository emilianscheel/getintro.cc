    ...
    <>
          ...
          <AnimatePresenceGuard>
            ...
            >
              <Button className={cn("relative px-8 gap-2")} shine>
                ...
                <Kbd className="ml-2 bg-foreground/30 text-foreground">
                  enter
                </Kbd>
              </Button>
      ...
      <AnimatePresence>
        {showDemo && (
          ...
          >
            <button
              className="absolute top-6 right-6 z-10 flex items-center gap-2 rounded-lg bg-white/10 px-3 py-2 text-sm font-medium text-white/90 hover:bg-white/20 transition-colors backdrop-blur-sm outline-none focus:outline-none"
            >
